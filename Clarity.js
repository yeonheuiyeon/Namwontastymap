...
function foo() {
    ...
    switch(b){
        case 1:
                ...
                tab.document.write('<img src="4.jpg"><a href="https://www.youtube.com/watch?v=U11adHxefik&feature=youtu.be"><img src="artvillage.png" style="width:315px;height:200px;margin-right:60%;margin-left:40%;"></a><img src="gameb.png" style="width:315px;height:200px;margin-right:60%;margin-left:40%;" onclick="self.close();" />');
                tab.document.location = "#";
	            break;
        case 2:
                
                tab.document.write('<img src="5.jpg"><a href="https://www.youtube.com/watch?v=1jhEa-NTiq0&feature=youtu.be"><img src="artvillage.png" style="width:315px;height:200px;margin-right:60%;margin-left:40%;"></a><img src="gameb.png" style="width:315px;height:200px;margin-right:60%;margin-left:40%;" onclick="self.close();" />');
                tab.document.location = "#";
                break;
        case 3:
                
                tab.document.write('<img src="6.jpg"><a href="https://www.youtube.com/watch?v=JsL0jHSDi3g&feature=youtu.be"><img src="artvillage.png" style="width:315px;height:200px;margin-right:60%;margin-left:40%;"></a><img src="gameb.png" style="width:315px;height:200px;margin-right:60%;margin-left:40%;" onclick="self.close();" />');
                tab.document.location = "#";
                break;
        case 4:
        ...
        case 5:
                ...
                tab.document.write('<img src="8.jpg"><a href="https://www.youtube.com/watch?v=Euwae4XIYRk&feature=youtu.be"><img src="artvillage.png" style="width:315px;height:200px;margin-right:60%;margin-left:40%;"></a><img src="gameb.png" style="width:315px;height:200px;margin-right:60%;margin-left:40%;" onclick="self.close();" />');
                tab.document.location = "#";
                break;
        case 6:
                
                tab.document.write('<img src="9.jpg"><a href="https://www.youtube.com/watch?v=-rciTWWVXoA&feature=youtu.be"><img src="artvillage.png" style="width:315px;height:200px;margin-right:60%;margin-left:40%;"></a><img src="gameb.png" style="width:315px;height:200px;margin-right:60%;margin-left:40%;" onclick="self.close();" />');
                tab.document.location = "#";
                break;
        case 7:
                
                tab.document.write('<img src="10.jpg"><a href="https://www.youtube.com/watch?v=bTk_o2XeYjY&feature=youtu.be"><img src="artvillage.png" style="width:315px;height:200px;margin-right:60%;margin-left:40%;"></a><img src="gameb.png" style="width:315px;height:200px;margin-right:60%;margin-left:40%;" onclick="self.close();" />');
                tab.document.location = "#";
                break;
        case 8:
                
                tab.document.write('<img src="11.jpg"><a href="https://www.youtube.com/watch?v=htPKdNXISY4&feature=youtu.be"><img src="artvillage.png" style="width:315px;height:200px;margin-right:60%;margin-left:40%;"></a><img src="gameb.png" style="width:315px;height:200px;margin-right:60%;margin-left:40%;" onclick="self.close();" />');
                tab.document.location = "#";
                break;
       case 9:
...
function foo2(){
    var tab1 = window.open();
    tab1.document.write('<img src="final.jpg" style="max-width: 100%; height: auto;"><img src="restart.png" style="width:315px;height:200px;margin-right:60%;margin-left:40%;" onclick="self.close();" />');
    tab1.document.location = "#";
}
